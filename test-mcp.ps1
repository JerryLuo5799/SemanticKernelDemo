...
# 测试 Test MCP 服务器
Write-Host "Testing Test MCP Server..."

# 启动 MCP 服务器进程
$mcpProcess = Start-Process -FilePath "dotnet" -ArgumentList "run --project TestMcpServer/TestMcpServer.csproj" -NoNewWindow -PassThru -RedirectStandardInput -RedirectStandardOutput -RedirectStandardError
